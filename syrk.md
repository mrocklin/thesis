...
There are two results in the above experiment.  First, there is a numeric speedup of a common algorithm.  Second, this speedup was found and implemented only because we were able to engage a domain expert and because that domain expert was able to contribute to the codebase.  He did not need deep understanding of the mathematical or compiler layers.  His contribution was limited to his area of expertise.
