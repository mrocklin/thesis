...
This approach is taken by systems like Supermatrix, Elemental, BLACS, and most recently, DAGuE\ref{Bosilca2012}.  These systems all move regularly sized blocks between connected nodes to perform relatively similarly timed operations.  In the case of DAGuE information about the network can be encoded.
